...
export function Prospecting(){
  ...
  const selectClient=(value:string)=>{const selected=clients.find(client=>clientOption(client)===value);setClientSearch(value);setForm(current=>({...current,client_id:selected?.id??null}))}
